...
CREATE TYPE "public"."focus_slot" AS ENUM('deep_work_1', 'deep_work_2', 'admin_block_1', 'admin_block_2', 'meetings', 'buffer', 'morning_routine', 'evening_review');--> statement-breakpoint
CREATE TYPE "public"."meal_type" AS ENUM('breakfast', 'lunch', 'dinner', 'snack');--> statement-breakpoint
CREATE TYPE "public"."milestone_status" AS ENUM('not_started', 'in_progress', 'done', 'blocked');--> statement-breakpoint
...
CREATE INDEX "idx_milestones_order" ON "milestones" USING btree ("order");--> statement-breakpoint
